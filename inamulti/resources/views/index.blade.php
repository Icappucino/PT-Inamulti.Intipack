...
<body>
    ...
    @yield('Career')
    <!-- Section Career Ended -->

    <!-- Section Peluang Bisnis Start -->
    @yield('Peluang-Bisnis')
    <!-- Section Peluang Bisnis Ended -->

    <!-- Section Contact Start -->
    @yield('Contact')
    <!-- Section Contact Ended -->

    <!-- Section Produk Details Start -->
    @yield('Astroll')
    @yield('Amidroll')
    @yield('Kofil')
    <!-- Section Produk Details Ended -->
